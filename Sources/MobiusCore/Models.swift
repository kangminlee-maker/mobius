...
public struct AccountProfile: Codable, Equatable, Identifiable, Sendable {
    ...
    /// 하위호환 디코딩 — provider 필드가 없는 구버전 프로필은 Claude로 간주한다.
    public init(from decoder: Decoder) throws {
        ...
        tierDescription = try c.decode(String.self, forKey: .tierDescription)
...
public struct AccountsFile: Codable, Equatable, Sendable {
    ...
    /// 리셋 프로브(한도 초기화 확정 최소 호출, experimental — 기본 끔).
    /// 설계·실측: docs/design/reset-probe-prep.md
    public var resetProbeEnabled: Bool
